// Initialization function wrapping everything
function init() {
    ...
    setTimeout(function () {
        elems.forEach(function (elem, _index) {
    ...
    document.body.addEventListener('mouseleave', function (_e) {
        elems.forEach(function (elem, _index) {
            elem.style.transition = "all .5s";
            elem.style.transform = "none";
        });
    ...
    document.body.addEventListener('mouseenter', function (_e) {
        elems.forEach(function (elem, _index) {
            setTimeout(function () {
...
//  the part that I did is to add the event listener to the window object
